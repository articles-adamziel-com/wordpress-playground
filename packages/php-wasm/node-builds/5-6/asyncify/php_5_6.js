...
// Compile with: node packages/php-wasm/compile/build.js --PLATFORM=node --PHP_VERSION=5.6
...
export function init(RuntimeName, PHPLoader) {
	throw new Error(
		'PHP 5.6 WASM binaries have not been compiled yet. ' +
			'Run: node packages/php-wasm/compile/build.js --PLATFORM=node --PHP_VERSION=5.6'
	);
}
