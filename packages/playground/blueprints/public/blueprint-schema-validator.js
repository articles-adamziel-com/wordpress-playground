...
const schema40 = { type: 'object', additionalProperties: { type: 'string' } };
function validate41(
	data,
	{ instancePath = '', parentData, parentDataProperty, rootData = data } = {}
) {
