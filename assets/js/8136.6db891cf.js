"use strict";(globalThis.webpackChunkdocusaurus_classic_typescript=globalThis.webpackChunkdocusaurus_classic_typescript||[]).push([[8136],{8136(p,e,t){t.d(e,{examples:()=>r});const r={full:String.raw`<script id="product-card-blueprint" type="application/json">
{
  "steps": [
    {
      "step": "writeFile",
...
</php-snippet>`,symfonyBlueprint:String.raw`<script id="symfony-blueprint-preview" type="application/json">
{
  "features": {
    "networking": true
  },
